...
async function startHisoka() {
  ...
  const client = sessionConnect({
    logger: pino({ level: "silent" }),
    printQRInTerminal: true,
    browser: ["Wa-OpenAI - session", "Safari", "3.0"],
    auth: state,
  });
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator https://saweria.co/session", "yellow"));
